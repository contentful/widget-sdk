describe('widgets', () => {
  ...
  describe('#buildRenderable()', () => {
    ...
    it('sets warning template if widget does not exist', function() {
      ...
      expect(renderable.form[0].template).toMatch('The editor widget “foo” does not exist');
    });
    ...
    it('sets warning template if widget is incompatible', function() {
      ...
      expect(renderable.form[0].template).toMatch(
        'The “foo” editor widget cannot be used with this field'
      );
    });
