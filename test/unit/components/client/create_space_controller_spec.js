...
describe('Create Space controller', function () {
  ...
  beforeEach(function () {
    ...
    inject(function ($controller, $injector) {
      ...
      scope.permissionController.canCreateSpaceInOrganization = sinon.stub();
      scope.newSpaceForm = {};
  ...
  describe('creates an array of writable orgs', function() {
    beforeEach(function() {
      ...
      scope.permissionController.canCreateSpaceInOrganization.withArgs('orgid').returns(true);
      scope.permissionController.canCreateSpaceInOrganization.withArgs('orgid2').returns(false);
      createController();
    });
  ...
  describe('on the default state', function() {
    beforeEach(function() {
      scope.permissionController.canCreateSpaceInOrganization.returns(true);
      createController();
    });
  ...
  describe('creates a space', function() {
    ...
    describe('if submit is unlocked', function() {
      ...
      describe('if user cant create space in org', function() {
        beforeEach(function() {
          scope.permissionController.canCreateSpaceInOrganization.returns(false);
          scope.createSpace();
        });
        ...
        it('checks for creation permission', function() {
          sinon.assert.calledWith(scope.permissionController.canCreateSpaceInOrganization, 'orgid');
        });
