...
describe('Enterprise Space Wizard', () => {
  beforeEach(function () {
    ...
    const EnterpriseSpaceWizard = this.$inject('components/shared/enterprise-space-wizard/EnterpriseSpaceWizard').default;

    this.createSpace = sinon.stub();

    this.component = mount(<EnterpriseSpaceWizard
      store={this.store}
