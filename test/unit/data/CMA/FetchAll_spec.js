...
describe('FetchAll', () => {
  ...
  describe('when there is only one page of results', () => {
    ...
    it('fetches the first page', function () {
      ...
      sinon.assert.calledOnce(this.stub.withArgs({ method: 'GET', path: '/path', query: this.query }));
    });
  ...
  describe('when there is more than one page of results', () => {
    it('fetches all pages', function () {
      ...
      sinon.assert.called(stub.withArgs({ method: 'GET', path: '/path', query: { skip: 10, limit: 10 } }));
