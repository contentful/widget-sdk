...
| reference_editor | create_entry                              | <code>locales_count: number<br />localized_fields_count: number<br />fields_count: number <br/>widgets_count: number<br>inline_bulk_feature_enabled:boolean</code>
...
| reference_editor | toggle_inline_bulk_editor                              | <code>toggle_state: boolean<br></code>
