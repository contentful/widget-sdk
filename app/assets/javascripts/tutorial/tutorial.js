...
////////////////////////////////////////////////////////////////////////////////
      ...
      createGuider({
        ...
        attachTo: '.tab-content:visible .cf-field-settings-editor *[name="fieldApiName"]',
        position: '11',
        buttons: [next],
      ...
      createGuider({
        ...
        onShow: function (guider) {
          repositionLater();
          guider.scope.waitFor(function () {
            return _.find(guider.attachScope.contentType.data.fields, {type: 'Text', name: 'Body', apiName: 'body'});
          }, function () {
            guiders.next();
          });
        },
      ...
      createGuider({
        ...
        onShow: function (guider) {
          repositionLater();
          guider.scope.waitFor(function () {
            return _.find(guider.attachScope.contentType.data.fields, {type: 'Date', name: 'Timestamp', apiName: 'timestamp'});
          }, function () {
            guiders.next();
          });
        },
        ...
        onShow: function (guider) {
          ...
          guider.scope.waitFor(function () {
            return _.find(guider.attachScope.contentType.data.fields, function (field) {
              return field.type == 'Link' && field.linkType == 'Asset' && field.name == 'Image' && field.apiName == 'image';
            });
          }, function () {
            guiders.next();
          });
