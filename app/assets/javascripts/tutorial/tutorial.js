...
angular.module('contentful').factory('tutorial', ['$compile', 'notification', 'tutorialExampledata', '$q', '$timeout', '$rootScope', 'analytics', 'sentry', 'environment', 'debounce', 'throttle', function ($compile, notification, tutorialExampledata, $q, $timeout, $rootScope, analytics, sentry, environment, debounce, throttle) {
  ...
  var next = {name: '<i class="ss-navigateright"></i>', classString: 'btn btn--default next-button', onclick: function(){guiders.next();}};
...
////////////////////////////////////////////////////////////////////////////////
      ...
      createGuider({
        ...
        position: 5,
        xButton: false,
        buttons: [{name: 'OK', classString: 'btn btn--default btn--primary', onclick: function(){guiders.hideAll();}}]
      });
...
////////////////////////////////////////////////////////////////////////////////
      ...
      createGuider({
        ...
        attachTo: '.entry-editor:visible .l-form-field[data-field-id="question"] textarea',
        position: '2',
        next: 'entryAnswers',
        buttons: [next],
        onShow: function (guider) {
      ...
      createGuider({
        ...
        attachTo: '.entry-editor:visible .l-form-field[data-field-id="answer1"] textarea',
        position: '2',
        next: 'entryAsset',
        buttons: [next],
        onShow: function (guider) {
      ...
      createGuider({
        ...
        attachTo: '.entry-editor:visible .l-form-field[data-field-id="image"] .add-new:visible',
        position: '11',
        next: 'assetTitle',
        onShow: function () {
          $(this.attachTo).one('click', function () {
      ...
      createGuider({
        ...
        attachTo: '.asset-editor:visible .l-form-field[data-field-id="title"] input',
        position: '2',
        next: 'assetUpload',
        buttons: [next],
        onShow: function (guider) {
