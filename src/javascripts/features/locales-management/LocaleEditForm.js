...
import { withRouteNavigate } from 'core/react-routing';
...
export const LocaleEditForm = withRouteNavigate(
  class LocaleEditForm extends Component {
    static propTypes = {
    ...
    save = () => {
      return this.props.onSave(this.state.locale, this.props.initialLocale, this.localeList);
    };
      ...
      return (
        <>
          ...
          <Workbench>
            <Workbench.Header
              onBack={() => {
                this.props.navigate({ path: 'locales.list' });
              }}
