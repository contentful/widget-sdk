...
import * as fieldErrorMessageGenerators from './fieldErrorMessages';
...
export function validate(fieldName, value) {
  ...
  if (!validators[fieldName](value)) {
    return fieldErrorMessage(fieldName);
  }
...
export function fieldErrorMessage(fieldName, viaApi = false) {
  if (!fieldErrorMessageGenerators[fieldName]) {
    return 'Field is not valid';
  }

  return fieldErrorMessageGenerators[fieldName](viaApi);
}
