...
export async function save(webhook, spaceId, templateId, templateIdReferrer) {
...
export function remove(webhook, spaceId) {
  return getWebhookRepo({ spaceId }).remove(webhook);
}
