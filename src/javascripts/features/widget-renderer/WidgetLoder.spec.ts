...
describe('Loader', () => {
  ...
  describe('#warmup()', () => {
    ...
    describe('for apps', () => {
      it('fetches all installations', async () => {
    ...
    describe('for extensions', () => {
      it('fetches the specified extension', async () => {
        await loader.warmUp({ widgetNamespace: WidgetNamespace.EXTENSION, widgetId: 'my_id' });
        expect(get).toHaveBeenCalledTimes(1);
  ...
  describe('#warmUpWithEditorInterface()', () => {
    describe('with controls, sidebar and editor', () => {
    ...
    describe('with controls, sidebar and multiple editors', () => {
      it('warms up the correct widgets', async () => {
        const editorInterface: EditorInterface = {
          sys: {
            type: 'EditorInterface',
  ...
  describe('#getOne()', () => {
    it('returns an internal representation of the app', async () => {
      const appId = 'myapp';
  ...
  describe('#getWithEditorInterface()', () => {
    it('returns an internal representation of all the widgets', async () => {
      const appId = 'myapp';
  ...
  describe('#getMultiple()', () => {
    it('returns an internal representation of the requested widgets', async () => {
      const appId = 'myapp';
      const extensionId = 'myextension';
  ...
  describe('#evict()', () => {
    it('clears the data of a loaded entity', async () => {
      await loader.warmUp({ widgetNamespace: WidgetNamespace.EXTENSION, widgetId: 'my_id' });
