...
export function validate12hTime(time) {
  if (time) {
...
export function validate24hTime(time) {
  if (time) {
 ...
 * @returns {moment|null}
 */
export function parseFreeFormDate(dateString) {
  if (!dateString) {
    return null;
  }
 ...
 */
export function buildFieldValue(data, parse12hClock, useTime, useTimezone) {
