...
function header () {
  ...
  function descriptionAndEdit () {
    return [
      h('div.workbench-header__description', [
...
function fieldActionsContextMenu () {
  return h('div.ct-field__actions-menu.context-menu', {
    role: 'menu',
