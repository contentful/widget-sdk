...
export default class FunctionEditor extends React.Component {
    ...
    return (
      <div style={CONTAINER_STYLE}>
        ...
        <div style={INVOKE_STYLE}>
          ...
          <div style={INVOKE_COL_STYLE}>
            {res && (
              <React.Fragment key={JSON.stringify(res[1])}>
  ...
  renderActions() {
    return (
      <React.Fragment>
        ...
        <button className="btn-primary-action" onClick={() => this.save()}>
          Save
        </button>
        <button className="btn-action" onClick={() => this.invoke()}>
          Invoke
        </button>
        <button className="btn-action" onClick={() => this.save().then(() => this.invoke())}>
          Save and invoke
        </button>
      </React.Fragment>
    );
  ...
  invoke() {
    ...
    this.props.backend
      .invoke(fn.sys.id, body, !useToken)
      .then(
