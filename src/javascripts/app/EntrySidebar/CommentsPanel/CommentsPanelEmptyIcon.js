...
export default function CommentsPanelEmptyIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="150" viewBox="0 0 280 208.64">
      <linearGradient id="a" gradientUnits="userSpaceOnUse" y1="112.386" x2="280" y2="112.386">
        <stop offset="0" stopColor="#cfedf9" />
        <stop offset=".324" stopColor="#d5eff9" />
        <stop offset=".775" stopColor="#e7f6fc" />
      ...
      />
      <path
        d="M99.52 148.35c-3.69-5.57-10.76-5.94-16.33-2.25s-7.27 11.43-3.58 17c3.69 5.57 12.81 7.68 18.38 3.99 5.56-3.69 5.22-13.17 1.53-18.74z"
        fill="#0058b0"
      />
      <path
