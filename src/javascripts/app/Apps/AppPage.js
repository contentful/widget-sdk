...
const styles = {
  ...
  heading: css({ display: 'flex', alignItems: 'center' }),
  tag: css({ marginLeft: tokens.spacingS }),
  ...
  noConfigSection: css({ maxWidth: '700px', margin: '0 auto', padding: tokens.spacingXl }),
  noConfigHelpText: css({ marginTop: tokens.spacingM }),
};
