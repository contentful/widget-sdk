  ...
  <svg
    ...
    <defs>
      ...
      <mask width="16" height="16" x="0" y="0" fill="#fff" id="breadcrumbs-icon-settings--b">
        <use xlinkHref="#breadcrumbs-icon-settings--a" />
      </mask>
    </defs>
    <g fill="none" fillRule="evenodd" stroke="#A9B9C0">
      <path d="M7.9 10.5A2.507 2.507 0 0 1 5.4 8c0-1.375 1.125-2.5 2.5-2.5s2.5 1.125 2.5 2.5-1.125 2.5-2.5 2.5z" />
      <use
        strokeWidth="2"
        mask="url(#breadcrumbs-icon-settings--b)"
        xlinkHref="#breadcrumbs-icon-settings--a"
      />
    </g>
  </svg>
);
