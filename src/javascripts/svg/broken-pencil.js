...
export default props => (
  <svg id="Layer_1" data-name="Layer 1" viewBox="0 0 295 202.81" {...props}>
    <defs>
      <linearGradient
        id="linear-gradient"
        x1={8.04}
        ...
        <stop offset={0.99} stopColor="#cfedf9" />
      </linearGradient>
    ...
    <circle className="cls-4" cx={190.6} cy={91.42} r={2.39} />
    <circle className="cls-4" cx={153.57} cy={50.77} r={2.63} />
    <circle className="cls-4" cx={189.65} cy={120.57} r={2.34} />
    <path
      className="cls-4"
