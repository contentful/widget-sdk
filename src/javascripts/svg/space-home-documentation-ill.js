...
const Illustration = ({ className }) => {
  return (
    <svg
      ...
      <path
        transform="rotate(45 281.76 127.562)"
        fill="#00de91"
        d="M265.32 111.13h32.87V144h-32.87z"
      />
      <path
      ...
      <path
        fill="#3397f5"
        d="M116.52 51.62L88.16 67.91l-.07 32.7 28.28 16.42 28.36-16.29.07-32.7z"
      />
    </svg>
  );
};
