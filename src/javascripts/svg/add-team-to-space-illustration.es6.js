...
export default props => (
  <svg id="prefix__Layer_1" data-name="Layer 1" viewBox="0 0 290 199.38" {...props}>
    <defs>
      <clipPath id="prefix__clip-path">
        <circle className="prefix__cls-1" cx={71.12} cy={96.99} r={55} />
      </clipPath>
      <clipPath id="prefix__clip-path-2">
        <circle className="prefix__cls-1" cx={233.13} cy={96.73} r={55} />
      </clipPath>
      <clipPath id="prefix__clip-path-3">
        <circle className="prefix__cls-1" cx={156.01} cy={96.99} r={55} />
      </clipPath>
      <linearGradient
    ...
    />
    <circle className="prefix__cls-3" cx={71.12} cy={96.99} r={55} />
    ...
    <circle className="prefix__cls-8" cx={71.12} cy={96.99} r={55} />
    <path
    ...
    />
    <circle className="prefix__cls-3" cx={233.13} cy={96.73} r={55} />
    ...
    <circle className="prefix__cls-8" cx={233.13} cy={96.73} r={55} />
    <path
      className="prefix__cls-7"
    ...
    />
    <circle className="prefix__cls-3" cx={156.01} cy={96.99} r={55} />
    ...
    <circle className="prefix__cls-8" cx={156.01} cy={96.99} r={55} />
    <path
      className="prefix__cls-5"
