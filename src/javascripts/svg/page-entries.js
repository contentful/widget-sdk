...
export default () => (
  <svg width="40" height="37" viewBox="-1 -1 42 39" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd">
      <g>
        <g>
          <rect stroke="#21304A" strokeWidth="2" fill="#F3EFBC" width="27" height="37" rx="2" />
          <g transform="rotate(45 15.593 40.104)">
            ...
            <path
              ...
              strokeLinejoin="round"
            />
            <path d="M10 34.488v-7.073" stroke="#21304A" strokeLinecap="square" />
