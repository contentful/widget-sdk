...
import registerAuthorization from 'services/authorization.es6'; // done
import registerClient from 'services/client.es6'; // done
import registerSpaceContext from 'classes/spaceContext.es6'; // done
import registerClientController from 'components/client/ClientController.es6'; // done
import registerStatesConfig from 'states/config.es6'; // done

import registerAppContainerDirective from 'components/app_container/cfAppContainerDirective.es6'; // ok
import registerSidepanelDirective from 'navigation/Sidepanel/directive.es6'; // done
import registerComponentBridgeDirective from 'ui/Framework/CfComponentBridgeDirective.es6'; // ok
import registerSidepanelTriggerDirective from 'navigation/Sidepanel/TriggerDirective.es6'; // done
import registerAccountDropdownDirective from 'navigation/accountDropdownDirective.es6'; // ok
import registerPersistentNotification from 'components/shared/persistent_notification/cfPersistentNotificationDirective.es6'; // done
...
export default angular
  ...
  .run([
    ...
    async $injector => {
      ...
      const { default: servicesModalDialogServiceEs6 } = await import(
        'services/modalDialogService.es6'
      );
      ...
      const { default: navigationStateChangeHandlersEs6 } = await import(
        'navigation/stateChangeHandlers.es6'
      );
