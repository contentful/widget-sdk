...
export const FLAGS = {
  ...
  NEW_ENTITY_FIELD: 'react-migration-12-2020-new-entity-field',
  NEW_SLIDE_IN_EDITOR: 'react-migration-11-2020-new-slide-in-editor',
...
const FALLBACK_VALUES = {
  ...
  [FLAGS.NEW_ENTITY_FIELD]: false,
  [FLAGS.NEW_SLIDE_IN_EDITOR]: false,
