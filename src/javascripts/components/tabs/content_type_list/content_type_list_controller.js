...
angular.module('contentful').controller('ContentTypeListController', [
  '$scope',
  'require',
  ($scope, require) => {
    ...
    function updateList() {
      ...
      spaceContext
        ...
        .then(res => {
          ...
          $scope.visibleContentTypes = contentTypes
    ...
    $scope.hasQuery = () =>
      _.isString($scope.context.searchTerm) && $scope.context.searchTerm.length > 0;
