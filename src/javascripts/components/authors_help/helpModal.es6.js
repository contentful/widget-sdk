    ...
    template: h('.modal-background', [
      h(`.modal-dialog.${prefix}__modal`, [
        ...
        h(`.${prefix}__container`, [
          h(`h3.${prefix}__title`, [
            'Hi {{ name }}. Welcome to Contentful.'
          ]),
          h(`.${prefix}__description`, [
            'Your place to create and manage content collaboratively'
          ]),
          h(`.${prefix}__line`),
          renderList(),
          h(`.${prefix}__footer`, [
...
function renderList () {
  return h(`ul.${prefix}__list`, [
    ...
    renderListElement([
      ...
      h('a', {
        href: 'https://www.contentful.com/blog/2017/11/28/work-smarter-with-our-new-search-features/',
        target: '_blank',
...
function renderFeedback () {
  return h(`.${prefix}__feedback`, [
    h(`.${prefix}__feedback-container`, {
      ngShow: 'needFeedback'
    }, [
      'Was this helpful?',
      h(`.${prefix}__feedback-choice`, {
