...
export default function template () {
  return h('div', [
    ...
    h('.docs-helper__line', ['Entries are your content.']),
    h('hr'),
    h('.docs-helper__line', [
      h('strong', {style: 'color: #3eab59;'}, ['Get them all'])
    ]),
    h('.docs-helper__line', ['You can fetch all of your entries in this space like this:']),
    h('code.docs-helper__line', [
    ...
    h('.docs-helper__line', ['Or, just the entries of the ', h('strong', ['ninja']), ' type:']),
    h('code.docs-helper__line', [
