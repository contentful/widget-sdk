...
angular
  ...
  .factory('spaceContext', [
    ...
    require => {
      ...
      const createSpaceEndpoint = require('data/Endpoint.es6').createSpaceEndpoint;
      ...
      const DocumentPool = require('data/sharejs/DocumentPool.es6');
      ...
      const createLocaleRepo = require('data/CMA/LocaleRepo.es6').default;
      const accessChecker = require('access_control/AccessChecker');
      const shouldUseEnvEndpoint = require('data/shouldUseEnvEndpoint.es6').default;
