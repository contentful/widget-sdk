...
const SpacesTabs = props => {
  ...
  return (
    <>
      ...
      <Tabs withDivider={true}>
        <Tab id="cmaRequests" selected={selected === 'cmaRequests'} onSelect={handleSelected}>
          CMA Requests
        </Tab>
        <Tab id="cdaRequests" selected={selected === 'cdaRequests'} onSelect={handleSelected}>
          CDA Requests
        </Tab>
        <Tab id="cpaRequests" selected={selected === 'cpaRequests'} onSelect={handleSelected}>
          CPA Requests
        </Tab>
        <Tab id="gqlRequests" selected={selected === 'gqlRequests'} onSelect={handleSelected}>
          GraphQL Requests
        </Tab>
      </Tabs>
