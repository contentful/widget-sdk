...
export default function SidepanelNoOrgs (props) {
  ...
  return <div className='nav-sidepanel__no-orgs' data-test-id='sidepanel-no-orgs'>
    <Icon name='space' />
    <p className='nav-sidepanel__no-orgs-heading'>
      Uh oh! Nothing to see here
    </p>

    <p>
      <Fragment>Seems like you aren&apos;t part of any organization.&#32;</Fragment>
      <a className='text-link' onClick={createNewOrg}>Create an organization</a>
