...
export function create(editor) {
  ...
  /**
   * @ngdoc method
   * @name markdown_editor/commands#hr
   * @description
  ...
  /**
   * @ngdoc method
   * @name markdown_editor/commands#indent
   * @description
  ...
  /**
   * @ngdoc method
   * @name markdown_editor/commands#dedent
   * @description
  ...
  /**
   * @ngdoc method
   * @name markdown_editor/commands#table
   * @description
  ...
  /**
   * @ngdoc method
   * @name markdown_editor/commands#link
   * @description
