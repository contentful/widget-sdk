...
describe('Kaltura Client Wrapper', function() {
  var kalturaCredentialsDeferred, kalturaClientWrapper,
      kalturaClientMock, KalturaErrorMessages, $q, $rootScope;
  ...
  describe('#_processResponseFromKalturaAPI', function() {
    function simulateCallTo_processResponseFromKalturaAPI(response){
    ...
    describe('when the request fails', function() {
      ...
      function failRequest(errorCode){
        simulateCallTo_processResponseFromKalturaAPI({code: errorCode})
    ...
    describe('when the request succeeds', function() {
      ...
      beforeEach(function() {
        simulateCallTo_processResponseFromKalturaAPI('response_from_kaltura')
